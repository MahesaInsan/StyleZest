...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }} " style="height:100vh">
    ...
    <body class="h-100 d-flex justify-content-center align-items-center" style="height:100vh; background-image: url('/images/stylezestAssets/bgImage.jpg'); background-repeat: no-repeat; background-size:cover">
        <div class="container h-75 shadow rounded row" style="background-color: white">
            <div class="h-100 col-6 border-end" style="border-right-width: 2px">
                <div class="h-100 d-flex flex-column justify-content-center align-items-center gap-4">
                    <div class="col-5 d-flex flex-column justify-content-center align-items-center h-75">
                        <img class="h-50" src="{{ asset('storage/images/customs/' . $custom->logo) }}" alt="" style="object-fit:cover">
                    ...
                    <div class="col-5 d-flex flex-column justify-content-center align-items-center">
                        <img class="w-75" src="{{url('/images/stylezestAssets/StyleZest-Logo.png')}}" alt="">
                        <h4>StyleZest</h4>
                    </div>
